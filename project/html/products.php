...
// option bar button
 $("#u1").click(function(){ // buttton template
      
      $("#dynamic_topic").text("My profile");  
       $.post("myprofile.php?username="+username+"&pwd="+pwd,function(data, status){
...
<article>
<h2 class="title" id="dynamic_topic">Welcome!</h2>
...
<footer><h2 class="title"></h2></footer>
</div>
